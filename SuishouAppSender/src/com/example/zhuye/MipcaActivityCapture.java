...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		String order_number=get_msg(resultString);
		Dingwei dingwei=new Dingwei();
		dingwei.order_num=order_number;
		
		String s1="haha";
		if(resultString.equals("订单号：201707260000012")){
			
			s1="hehe";
		}
		
		Toast.makeText(MipcaActivityCapture.this, s1,Toast.LENGTH_SHORT).show();
...
//		dingwei.order_num="1";
		...
		if (resultString.equals("")) {
			...
			//2017-07-25-10:55 for test
			
			Dingwei.order_num=resultString;
